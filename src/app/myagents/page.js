...
export default function Dashboard() {
      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="text-left bg-slate-800 text-slate-300">
            ...
            <th className="p-3 border-b border-slate-700">Revenue Generated</th>
          </tr>
        </thead>
        <tbody>
          {/* Dummy Data */}
          {[
            { name: "ChatBot Pro", category: "Customer Support", status: "Active", date: "Mar 10, 2025", revenue: "$1,250" },
            { name: "Finance GPT", category: "Finance Advisory", status: "Active", date: "Feb 28, 2025", revenue: "$980" },
            { name: "Code Assistant", category: "Developer Tools", status: "Inactive", date: "Jan 15, 2025", revenue: "$720" },
            { name: "Content AI", category: "Content Generation", status: "Active", date: "Mar 5, 2025", revenue: "$1,890" },
          ].map((agent, index) => (
  ...
  <CardFooter className="border-t border-slate-700/50 pt-3">
    <p className="text-slate-400 text-sm">Manage your purchased AI agents efficiently.</p>
  </CardFooter>
</Card>
